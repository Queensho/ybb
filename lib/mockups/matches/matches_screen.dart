...
class _MatchesScreenState extends State<MatchesScreen> {
  ...
  static const matches = <_MatchData>[
    ...
    _MatchData(
      ...
      age: 31,
      score: 88,
      interests: ['Spor', 'Film', 'Doğa'],
      status: '2 saat önce aktif',
      online: false,
    ...
    _MatchData(
      ...
      age: 30,
      score: 78,
      interests: ['Müzik', 'Spor', 'Teknoloji'],
      status: '5 saat önce aktif',
      online: false,
  ...
  Widget build(BuildContext context) {
    ...
    final visibleMatches = matches.where((m) {
      ...
      return m.name.toLowerCase().contains(query) ||
          ...
          m.interests.any((e) => e.toLowerCase().contains(query));
    }).toList();
              ...
              child: Row(
                children: [
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          borderSide: const BorderSide(color: Color(0xFF30263E)),
                        ),
                  ...
                  Container(
                    ...
                    child: Icon(Icons.tune_rounded, color: context.tokens.lime),
                  ),
                ],
              ),
            ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Seninle uyumlu olabilecek kişiler',
                        style: context.texts.bodyLarge?.copyWith(color: const Color(0xFFD7CDE4)),
                      ),
                    ],
                  ),
                ),
...
class _Meta extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Row(
        ...
        children: [
          ...
          Icon(icon, color: const Color(0xFFBDB5C7), size: 17),
          const SizedBox(width: 4),
          Text(text, style: const TextStyle(color: Color(0xFFC9C3D5), fontSize: 13)),
        ],
      );
}

class _Interest extends StatelessWidget {
  const _Interest({required this.label});
  final String label;
  @override
  Widget build(BuildContext context) => Container(
        padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 5),
        decoration: BoxDecoration(color: const Color(0xFF1B1825), borderRadius: BorderRadius.circular(999)),
        child: Text(label, style: const TextStyle(color: Color(0xFFD1CAD9), fontSize: 12)),
      );
}
    ...
    return SafeArea(
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: const [
            _NavItem(icon: Icons.favorite_rounded, label: 'Eşleşmeler', active: true),
            _NavItem(icon: Icons.explore_outlined, label: 'Keşfet'),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        if (active) ...[
          const SizedBox(height: 6),
          Container(width: 38, height: 4, decoration: BoxDecoration(color: context.tokens.lime, borderRadius: BorderRadius.circular(999))),
        ],
      ],
    );
  }
