            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const _InfoCard(
                    children: [
                      Text('Yeni insanlarla tanışmayı, güzel sohbetleri ve küçük kaçamakları seviyorum. Ortak noktalarımız varsa tanışalım.', style: TextStyle(color: Color(0xFFD5CDDF), fontSize: 15, height: 1.55)),
                    ],
                  ),
                ],
              ),
          ...
          child: Row(
            children: [
              Container(
                width: 58,
                height: 58,
                decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: const Color(0xFF4C405E))),
                child: Icon(Icons.favorite_border_rounded, color: context.tokens.lime),
              ),
        ...
        children: [
          Row(
            children: [
              Container(
                width: 48,
                height: 48,
                decoration: BoxDecoration(color: const Color(0xFF25183B), borderRadius: BorderRadius.circular(16)),
                child: Icon(Icons.auto_awesome_rounded, color: context.tokens.lime),
              ),
              const SizedBox(width: 12),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text('Eşleşme uyumu', style: TextStyle(color: Colors.white70, fontWeight: FontWeight.w600)),
                    Text('%$score', style: TextStyle(color: context.tokens.lime, fontSize: 30, fontWeight: FontWeight.w900)),
                  ],
                ),
              ),
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              value: score / 100,
              minHeight: 8,
              backgroundColor: const Color(0xFF30283A),
          ...
          const Align(
            ...
            child: Text('Cevaplarınız ve partner tercihleriniz karşılaştırılarak hesaplanır.', style: TextStyle(color: Color(0xFF948B9E), fontSize: 12, height: 1.35)),
          ),
        ],
      ),
    );
...
class _SectionTitle extends StatelessWidget {
  ...
  final String text;
  @override
  Widget build(BuildContext context) => Text(text, style: const TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w900));
}
...
class _Chip extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFF21162F), borderRadius: BorderRadius.circular(99), border: Border.all(color: const Color(0xFF47266B))),
        child: Text(label, style: const TextStyle(color: Color(0xFFDCCBEE), fontWeight: FontWeight.w600)),
      );
}
...
class _InfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        padding: const EdgeInsets.all(18),
        decoration: BoxDecoration(color: const Color(0xFF14111D), borderRadius: BorderRadius.circular(26), border: Border.all(color: const Color(0xFF30263E))),
        ...
        child: Row(
          children: [
            Container(
              width: 42,
              height: 42,
              decoration: BoxDecoration(color: const Color(0xFF21162F), borderRadius: BorderRadius.circular(14)),
              child: Icon(icon, color: context.tokens.lime, size: 21),
            ),
            const SizedBox(width: 12),
            Expanded(child: Text(title, style: const TextStyle(color: Color(0xFFAAA1B4), fontSize: 14))),
