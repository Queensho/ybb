      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            _SectionTitle('Gizlilik ve güvenlik'),
            _SettingsCard(children: [
            ...
            const SizedBox(height: 22),
            _SectionTitle('Keşfet ve eşleşme'),
            _SettingsCard(children: [
            ...
            _SettingsCard(children: [
              _SwitchRow(icon: Icons.dark_mode_outlined, title: 'Koyu tema', value: darkMode, onChanged: (v) => setState(() => darkMode = v)),
            ]),
            const SizedBox(height: 22),
            _SectionTitle('Verilerim'),
            _SettingsCard(children: [
...
const _divider = Divider(height: 1, color: Color(0xFF2B2338));
...
class _SettingsRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Icon(icon, color: danger ? const Color(0xFFFF6B7A) : context.tokens.lime),
              const SizedBox(width: 13),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(title, style: TextStyle(color: danger ? const Color(0xFFFF6B7A) : Colors.white, fontWeight: FontWeight.w800)),
                    if (subtitle != null) ...[
                      const SizedBox(height: 4),
                      Text(subtitle!, style: const TextStyle(color: Color(0xFF9F96AA), fontSize: 12.5)),
                    ],
                  ],
                ),
              ),
