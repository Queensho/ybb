...
class _AboutQuestionScreenState extends State<AboutQuestionScreen> {
  ...
  void _pointerMove(PointerMoveEvent event) {
    ...
    if (_dragDistance < -12 && _heroVisible) {
      _dragDistance = 0;
      setState(() => _heroVisible = false);
    } else if (_dragDistance > 18 && !_heroVisible) {
      _dragDistance = 0;
...
class _AboutHero extends StatelessWidget {
  const _AboutHero({required this.questionIndex, required this.questionCount, required this.icon, required this.onBack});
